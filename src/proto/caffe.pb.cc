...
void protobuf_AssignDesc_caffe_2eproto() {
  ...
  NonMaximumSuppressionParameter_descriptor_ = file->message_type(46);
  ...
  DetectionOutputParameter_descriptor_ = file->message_type(47);
  ...
  PermuteParameter_descriptor_ = file->message_type(48);
  ...
  PriorBoxParameter_descriptor_ = file->message_type(49);
  ...
  ShuffleChannelParameter_descriptor_ = file->message_type(50);
  ...
  NormalizeParameter_descriptor_ = file->message_type(51);
  ...
  V1LayerParameter_descriptor_ = file->message_type(52);
