...
include_directories(/home/cooperzhang/face/openblas-linux/include)
link_directories(/home/cooperzhang/face/openblas-linux/lib)
...
if(USE_CUDA)
  add_library(caffe_gpu SHARED ${CAFFE_COMPILE_CODE})
  target_link_libraries(caffe_gpu ${Caffe_LINKER_LIBS})
else()
